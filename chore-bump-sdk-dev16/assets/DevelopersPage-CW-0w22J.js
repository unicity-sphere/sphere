import{r as m,j as e,m as n,L as x,S as p,M as b,K as u,X as g,D as w,G as k,a as f}from"./index-DxIXvjBC.js";import{Z as y}from"./zap-BQ2KYQgj.js";const j=[{href:"https://x.com/unicity_labs",icon:e.jsx(g,{className:"w-6 h-6"}),label:"X"},{href:"https://discord.com/invite/PGzNZT5uVp",icon:e.jsx(w,{className:"w-6 h-6"}),label:"Discord"},{href:"https://github.com/unicity-sphere/sphere",icon:e.jsx(k,{className:"w-6 h-6"}),label:"GitHub"},{href:"https://www.linkedin.com/company/unicity-labs/",icon:e.jsx(f,{className:"w-6 h-6"}),label:"LinkedIn"}];function I(){const[t,h]=m.useState("init"),[i,l]=m.useState(null),o=(a,s)=>{navigator.clipboard.writeText(a),l(s),setTimeout(()=>l(null),2e3)},r={init:{Icon:u,title:"Initialization",tagline:"Your key is your identity.",description:"Provider-based architecture. Your BIP39 mnemonic IS your identity. Auto-creates or loads existing wallets.",code:"const { sphere } = await Sphere.init({ ...providers, mnemonic: '...' });",fullExample:`import { Sphere } from '@unicitylabs/sphere-sdk';
