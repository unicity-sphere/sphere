import{r as x,j as e,m as n,L as m,S as p,M as b,Z as u,K as g,X as w,D as k,G as f,a as y}from"./index-00NWU_G5.js";const j=[{href:"https://x.com/unicity_labs",icon:e.jsx(w,{className:"w-6 h-6"}),label:"X"},{href:"https://discord.com/invite/PGzNZT5uVp",icon:e.jsx(k,{className:"w-6 h-6"}),label:"Discord"},{href:"https://github.com/unicity-sphere/sphere",icon:e.jsx(f,{className:"w-6 h-6"}),label:"GitHub"},{href:"https://www.linkedin.com/company/unicity-labs/",icon:e.jsx(y,{className:"w-6 h-6"}),label:"LinkedIn"}];function v(){const[t,h]=x.useState("init"),[i,l]=x.useState(null),o=(a,s)=>{navigator.clipboard.writeText(a),l(s),setTimeout(()=>l(null),2e3)},r={init:{Icon:g,title:"Initialization",tagline:"Your key is your identity.",description:"Provider-based architecture. Your BIP39 mnemonic IS your identity. Auto-creates or loads existing wallets.",code:"const { sphere } = await Sphere.init({ ...providers, mnemonic: '...' });",fullExample:`import { Sphere } from '@unicitylabs/sphere-sdk';
