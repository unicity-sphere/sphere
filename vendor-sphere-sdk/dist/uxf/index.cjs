...
var import_dag_cbor3, import_SparseMerkleTreePath2;
...
var import_SparseMerkleTreePath = require("@unicitylabs/state-transition-sdk/lib/mtree/plain/SparseMerkleTreePath.js");
init_errors();
function makeHeader() {
  return {
    representation: 1,
