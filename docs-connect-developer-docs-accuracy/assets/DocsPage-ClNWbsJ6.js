import{r as m,j as e,m as g,b as j,c as N}from"./index-CdaGoXgr.js";const b="0.17.2",u=[{id:"getting-started",label:"Getting Started",children:[{id:"installation",label:"Installation"},{id:"quick-start",label:"Quick Start"},{id:"browser-setup",label:"Browser Setup"}]},{id:"core-concepts",label:"Core Concepts",children:[{id:"identity",label:"Identity & Keys"},{id:"addresses",label:"Addresses"},{id:"nametags",label:"Nametags (@username)"},{id:"token-model",label:"Token Model"},{id:"events-system",label:"Events System"}]},{id:"api-sphere",label:"Sphere (Static)",children:[{id:"api-sphere-init",label:"Sphere.init()"},{id:"api-sphere-exists",label:"Sphere.exists()"},{id:"api-sphere-mnemonic",label:"Mnemonic Utilities"}]},{id:"api-instance",label:"Sphere (Instance)",children:[{id:"api-instance-identity",label:"sphere.identity"},{id:"api-instance-nametag",label:"Nametags"},{id:"api-instance-resolve",label:"sphere.resolve()"},{id:"api-instance-events",label:"sphere.on()"},{id:"api-instance-wallet",label:"Wallet Management"}]},{id:"api-payments",label:"Payments (L3)",children:[{id:"api-payments-send",label:"payments.send()"},{id:"api-payments-getbalance",label:"payments.assets()"},{id:"api-payments-getassets",label:"payments.mint()"},{id:"api-payments-gettokens",label:"payments.tokens()"},{id:"api-payments-gethistory",label:"payments.history()"},{id:"api-payments-receive",label:"payments.receive()"},{id:"api-payments-request",label:"Payment Requests"}]},{id:"api-comms",label:"Communications",children:[{id:"api-comms-senddm",label:"sendDM()"},{id:"api-comms-ondm",label:"onDirectMessage()"},{id:"api-comms-conversations",label:"Conversations"},{id:"api-comms-broadcast",label:"Broadcasts"}]},{id:"api-groupchat",label:"Group Chat"},{id:"api-market",label:"Market"},{id:"connect",label:"Sphere Connect",children:[{id:"connect-overview",label:"Overview"},{id:"connect-how-it-works",label:"How It Works"},{id:"connect-autoconnect",label:"autoConnect()"},{id:"connect-resources",label:"Resources & Links"}]},{id:"guides",label:"Guides",children:[{id:"guide-marketplace",label:"Building a Marketplace"},{id:"guide-wallet-backup",label:"Wallet Backup & Recovery"}]},{id:"examples",label:"Examples",children:[{id:"example-payment",label:"Simple Payment"},{id:"example-marketplace",label:"P2P Marketplace"}]}],y=new RegExp(["(//[^\\n]*|/\\*[\\s\\S]*?\\*/)",`('(?:[^'\\\\\\n]|\\\\.)*'|"(?:[^"\\\\\\n]|\\\\.)*"|\\x60(?:[^\\x60\\\\]|\\\\.)*\\x60)`,"\\b(import|export|from|const|let|var|function|async|await|return|if|else|for|of|in|try|catch|finally|throw|new|class|extends|interface|type|typeof|instanceof|null|undefined|true|false|void|as|declare)\\b","\\b(0x[0-9a-fA-F]+|\\d[\\d_]*n?)\\b"].join("|"),"g"),f=["text-neutral-500 italic","text-emerald-400","text-sky-400","text-amber-400"];function w(n){const r=[];let i=0,c=0;for(const o of n.matchAll(y)){const d=o.index;d>i&&r.push(n.slice(i,d)),r.push(e.jsx("span",{className:f[o.slice(1).findIndex(Boolean)],children:o[0]},c++)),i=d+o[0].length}return i<n.length&&r.push(n.slice(i)),r}function v(n,r){return r!=="typescript"?!1:n?!/^(terminal|\.env|shell|bash|json|.*\.(env|sh|json|txt))$/i.test(n.trim()):!0}function t({code:n,filename:r,language:i="typescript"}){const[c,o]=m.useState(!1),d=async()=>{await N(n)&&(o(!0),setTimeout(()=>o(!1),2e3))};return e.jsxs("div",{className:"bg-neutral-900 rounded-xl overflow-hidden my-4",children:[e.jsxs("div",{className:"flex justify-between items-center px-4 py-2 border-b border-neutral-700",children:[e.jsx("span",{className:"text-xs text-neutral-400 font-mono",children:r||i}),e.jsx("button",{onClick:d,className:"text-xs text-neutral-400 hover:text-white transition",children:c?"✓ Copied":"Copy"})]}),e.jsx("pre",{className:"p-4 text-sm overflow-x-auto",children:e.jsx("code",{className:"text-neutral-200",children:v(r,i)?w(n):n})})]})}function x({params:n}){return e.jsx("div",{className:"overflow-x-auto my-4",children:e.jsxs("table",{className:"w-full text-sm",children:[e.jsx("thead",{children:e.jsxs("tr",{className:"text-left text-neutral-500 border-b border-neutral-200 dark:border-neutral-700",children:[e.jsx("th",{className:"pb-2 pr-4",children:"Parameter"}),e.jsx("th",{className:"pb-2 pr-4",children:"Type"}),e.jsx("th",{className:"pb-2",children:"Description"})]})}),e.jsx("tbody",{children:n.map((r,i)=>e.jsxs("tr",{className:"border-b border-neutral-100 dark:border-neutral-800",children:[e.jsxs("td",{className:"py-2 pr-4",children:[e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:r.name}),r.required&&e.jsx("span",{className:"text-red-500 ml-1",children:"*"})]}),e.jsx("td",{className:"py-2 pr-4 text-neutral-600 dark:text-neutral-400 font-mono text-xs",children:r.type}),e.jsx("td",{className:"py-2 text-neutral-600 dark:text-neutral-400",children:r.description})]},i))})]})})}function S(){const[n,r]=m.useState("getting-started"),[i,c]=m.useState(!1),[o,d]=m.useState(new Set(["getting-started","api-payments"]));m.useEffect(()=>{const a=()=>{const s=document.querySelectorAll("[data-section]");let l="getting-started";s.forEach(p=>{p.getBoundingClientRect().top<=100&&(l=p.getAttribute("data-section"))}),r(l)};return window.addEventListener("scroll",a),()=>window.removeEventListener("scroll",a)},[]);const h=a=>{const s=document.getElementById(a);s&&(s.scrollIntoView({behavior:"smooth",block:"start"}),r(a),c(!1),window.history.replaceState(null,"",`#${a}`))};m.useEffect(()=>{const a=window.location.hash.slice(1);if(a){for(const s of u)if(s.id===a||s.children?.some(l=>l.id===a)){d(l=>new Set(l).add(s.id));break}requestAnimationFrame(()=>{const s=document.getElementById(a);s&&(s.scrollIntoView({behavior:"smooth",block:"start"}),r(a))})}},[]);const k=a=>{d(s=>{const l=new Set(s);return l.has(a)?l.delete(a):l.add(a),l})};return e.jsxs(g.div,{initial:{opacity:0},animate:{opacity:1},className:"min-h-screen text-neutral-900 dark:text-white relative z-0",children:[e.jsx("button",{onClick:()=>c(!i),className:"lg:hidden fixed top-16 left-4 z-30 p-2 bg-white/80 dark:bg-neutral-800/80 backdrop-blur-lg rounded-lg border border-neutral-200 dark:border-neutral-700 text-neutral-600 dark:text-neutral-400 hover:text-neutral-900 dark:hover:text-white",children:e.jsx("svg",{className:"w-5 h-5",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:i?e.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M6 18L18 6M6 6l12 12"}):e.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M4 6h16M4 12h16M4 18h16"})})}),i&&e.jsx("div",{className:"fixed inset-0 z-10 bg-black/50 lg:hidden",onClick:()=>c(!1)}),e.jsx("aside",{className:`
        ...
        p-4 lg:py-8 lg:pr-8
      `,children:e.jsx("nav",{className:"space-y-1",children:u.map(a=>e.jsxs("div",{children:[e.jsxs("button",{onClick:()=>{a.children&&k(a.id),h(a.id)},className:`
                    w-full flex items-center justify-between px-3 py-2 text-sm font-medium rounded-lg transition
                    ${n===a.id||a.children?.some(s=>s.id===n)?"text-orange-600 dark:text-orange-400 bg-orange-50 dark:bg-orange-500/10":"text-neutral-600 dark:text-neutral-400 hover:text-neutral-900 dark:hover:text-white hover:bg-neutral-100 dark:hover:bg-neutral-800"}
                  `,children:[e.jsx("span",{children:a.label}),a.children&&e.jsx("svg",{className:`w-4 h-4 transition-transform ${o.has(a.id)?"rotate-90":""}`,fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:e.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M9 5l7 7-7 7"})})]}),a.children&&o.has(a.id)&&e.jsx("div",{className:"ml-4 mt-1 space-y-1",children:a.children.map(s=>e.jsx("button",{onClick:()=>h(s.id),className:`
                          w-full flex items-center px-3 py-1.5 text-sm rounded-lg transition
                          ${n===s.id?"text-orange-600 dark:text-orange-400":"text-neutral-500 dark:text-neutral-500 hover:text-neutral-900 dark:hover:text-white"}
                        `,children:e.jsx("span",{children:s.label})},s.id))})]},a.id))})}),e.jsxs("main",{className:"max-w-7xl mx-auto px-4 sm:px-6 py-8 lg:pl-72",children:[e.jsxs("section",{id:"getting-started","data-section":"getting-started",className:"mb-16",children:[e.jsxs("h1",{className:"text-3xl sm:text-4xl font-bold mb-4",children:["Sphere SDK",e.jsxs("a",{href:`https://www.npmjs.com/package/@unicitylabs/sphere-sdk/v/${b}`,target:"_blank",rel:"noopener noreferrer",className:"ml-3 text-sm font-normal text-neutral-500 hover:text-orange-500 transition align-middle",children:["v",b]})]}),e.jsx("p",{className:"text-lg text-neutral-600 dark:text-neutral-400 mb-8 max-w-2xl",children:"Build marketplaces where humans and AI agents trade anything. Payments, messaging, identity, and market intents in one SDK."}),e.jsxs("div",{id:"installation","data-section":"installation",className:"scroll-mt-24 mb-12",children:[e.jsx("h2",{className:"text-2xl font-bold mb-4",children:"Installation"}),e.jsx("p",{className:"text-neutral-600 dark:text-neutral-400 mb-4",children:"Install the Sphere SDK using npm or yarn:"}),e.jsx(t,{code:"npm install @unicitylabs/sphere-sdk",filename:"terminal"}),e.jsx(t,{code:"yarn add @unicitylabs/sphere-sdk",filename:"terminal"})]}),e.jsxs("div",{id:"quick-start","data-section":"quick-start",className:"scroll-mt-24 mb-12",children:[e.jsx("h2",{className:"text-2xl font-bold mb-4",children:"Quick Start"}),e.jsx("p",{className:"text-neutral-600 dark:text-neutral-400 mb-4",children:"Initialize a wallet and send your first payment:"}),e.jsx(t,{filename:"app.ts",code:`import { Sphere, TokenRegistry, getCoinIdBySymbol } from '@unicitylabs/sphere-sdk';
...
# autoGenerate; server-only secrets stay in a server-side process.`}),e.jsxs("p",{className:"text-neutral-600 dark:text-neutral-400 mt-4",children:["The legacy ",e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:"'testnet'"})," key still resolves to the same configuration as ",e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:"'testnet2'"}),", but new code should not use it. It is deliberately absent from ",e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:"SPHERE_NETWORKS"}),", which is what a dApp sends in a Connect handshake — and, more sharply, the init guard compares",e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:" walletApi.network"})," with",e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:" options.network"})," as raw strings. Passing",e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:" 'testnet'"})," to one and",e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:" 'testnet2'"})," to the other throws",e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:" INVALID_CONFIG"})," even though both name the same network. Use one literal — the ",e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:"NETWORK"})," constant in the samples above exists for exactly that reason."]})]})]}),e.jsxs("section",{id:"core-concepts","data-section":"core-concepts",className:"mb-16",children:[e.jsx("h2",{className:"text-2xl font-bold mb-6 pb-2 border-b border-neutral-200 dark:border-neutral-700",children:"Core Concepts"}),e.jsxs("div",{id:"identity","data-section":"identity",className:"scroll-mt-24 mb-12",children:[e.jsx("h3",{className:"text-xl font-semibold mb-4",children:"Identity & Keys"}),e.jsx("p",{className:"text-neutral-600 dark:text-neutral-400 mb-4",children:"Sphere uses cryptographic identity based on BIP39 mnemonics. Your mnemonic seed generates a hierarchical deterministic (HD) wallet with multiple addresses."}),e.jsxs("ul",{className:"list-disc list-inside text-neutral-600 dark:text-neutral-400 space-y-2 mb-4",children:[e.jsx("li",{children:"No registration or API keys needed"}),e.jsxs("li",{children:["BIP32 HD wallet with derivation path ",e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:"m/44'/0'/0'"})]}),e.jsx("li",{children:"Multiple addresses from a single seed"}),e.jsx("li",{children:"Identity includes chain pubkey, direct address, and optional nametag"})]}),e.jsxs("p",{className:"text-neutral-600 dark:text-neutral-400 mb-4",children:[e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:"sphere.identity"})," is populated once",e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:" Sphere.init()"})," resolves. Its type is",e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:" Identity | null"}),"."]}),e.jsx(t,{code:"console.log(sphere.identity);"}),e.jsx("p",{className:"text-neutral-600 dark:text-neutral-400 mb-4",children:"What it carries:"}),e.jsxs("ul",{className:"list-disc list-inside text-neutral-600 dark:text-neutral-400 space-y-2 mb-4",children:[e.jsxs("li",{children:[e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:"chainPubkey"})," — the compressed secp256k1 chain public key as hex, such as ",e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:"'02abc...'"})]}),e.jsxs("li",{children:[e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:"directAddress"})," — the L3 address, such as",e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:" 'DIRECT://...'"}),". Optional."]}),e.jsxs("li",{children:[e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:"nametag"})," — the bare name, such as",e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:" 'alice'"}),", with no leading",e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:" @"}),". Optional."]})]})]}),e.jsxs("div",{id:"addresses","data-section":"addresses",className:"scroll-mt-24 mb-12",children:[e.jsx("h3",{className:"text-xl font-semibold mb-4",children:"Addresses"}),e.jsx("p",{className:"text-neutral-600 dark:text-neutral-400 mb-4",children:"There are two address formats:"}),e.jsxs("ul",{className:"list-disc list-inside text-neutral-600 dark:text-neutral-400 space-y-2 mb-4",children:[e.jsxs("li",{children:[e.jsx("strong",{children:"DIRECT address"})," (",e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:"DIRECT://..."}),") - Used for L3 token transfers"]}),e.jsxs("li",{children:[e.jsx("strong",{children:"@nametag"})," (",e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:"@alice"}),") - A human-readable alias, resolved to a DIRECT address over transport"]})]}),e.jsxs("p",{className:"text-neutral-600 dark:text-neutral-400 mb-4",children:[e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:"PROXY://"})," is not an address type — it was removed from the SDK.",e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:" parseAddress()"})," returns",e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:" null"})," for one, and a send to it fails with",e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:" INVALID_RECIPIENT"}),": “Use @nametag, DIRECT://, or a hex pubkey.”"]}),e.jsx(t,{code:`const addr = sphere.deriveAddress(1);
console.log(addr.publicKey);

await sphere.switchToAddress(1);

const addresses = sphere.getActiveAddresses();`}),e.jsxs("p",{className:"text-neutral-600 dark:text-neutral-400 mb-4",children:["The index is zero-based, so ",e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:"deriveAddress(1)"})," derives the second address. ",e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:"addr.publicKey"})," is its chain pubkey as hex.",e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:" switchToAddress(1)"})," makes that address the active one, and",e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:" getActiveAddresses()"})," lists every address the wallet tracks."]})]}),e.jsxs("div",{id:"nametags","data-section":"nametags",className:"scroll-mt-24 mb-12",children:[e.jsx("h3",{className:"text-xl font-semibold mb-4",children:"Nametags (@username)"}),e.jsx("p",{className:"text-neutral-600 dark:text-neutral-400 mb-4",children:"Nametags are human-readable aliases registered on Nostr. Use them instead of addresses:"}),e.jsxs("p",{className:"text-neutral-600 dark:text-neutral-400 mb-4",children:["The ",e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:"@"})," is an input and display sigil only. The SDK strips it on registration and stores the bare name, so ",e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:"getNametag()"})," and",e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:" identity.nametag"})," return",e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:" 'alice'"})," — prepend the",e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:" @"})," yourself for display.",e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:" resolve()"})," and",e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:" send()"})," accept either form."]}),e.jsxs("p",{className:"text-neutral-600 dark:text-neutral-400 mb-4",children:["Register a nametag during wallet creation or at any time after it. Once registered it works as a recipient:",e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:" send()"})," resolves it to a DIRECT address for you."]}),e.jsx(t,{filename:"nametags.ts",code:`await sphere.registerNametag('alice');
...
});`})]}),e.jsxs("div",{id:"events-system","data-section":"events-system",className:"scroll-mt-24 mb-12",children:[e.jsx("h3",{className:"text-xl font-semibold mb-4",children:"Events System"}),e.jsxs("p",{className:"text-neutral-600 dark:text-neutral-400 mb-4",children:["Subscribe to SDK events using ",e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:"sphere.on(eventType, handler)"}),". Returns an unsubscribe function."]}),e.jsx(t,{code:`sphere.on('transfer:incoming', (transfer) => console.log(transfer.tokens));
...
unsub();`}),e.jsxs("ul",{className:"list-disc list-inside text-neutral-600 dark:text-neutral-400 space-y-2 mb-4",children:[e.jsxs("li",{children:[e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:"transfer:incoming"})," — a transfer arrived"]}),e.jsxs("li",{children:[e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:"transfer:updated"})," — an outgoing transfer changed state"]}),e.jsxs("li",{children:[e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:"message:dm"})," — a direct message arrived"]}),e.jsxs("li",{children:[e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:"payment_request:incoming"})," — a payment request arrived"]})]}),e.jsxs("p",{className:"text-neutral-600 dark:text-neutral-400 mb-4",children:["Calling the returned ",e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:"unsub()"})," stops that listener."]})]})]}),e.jsxs("section",{id:"api-sphere","data-section":"api-sphere",className:"mb-16",children:[e.jsx("h2",{className:"text-2xl font-bold mb-6 pb-2 border-b border-neutral-200 dark:border-neutral-700",children:"API Reference — Sphere (Static)"}),e.jsxs("div",{id:"api-sphere-init","data-section":"api-sphere-init",className:"scroll-mt-24 mb-12",children:[e.jsx("h3",{className:"text-xl font-semibold mb-4",children:e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:"Sphere.init(options)"})}),e.jsx("p",{className:"text-neutral-600 dark:text-neutral-400 mb-4",children:"Unified initialization: auto-loads an existing wallet or creates a new one."}),e.jsx("h4",{className:"font-medium text-lg mt-6 mb-3",children:"Signature"}),e.jsx(t,{code:"static async init(options: SphereInitOptions): Promise<SphereInitResult>"}),e.jsx("h4",{className:"font-medium text-lg mt-6 mb-3",children:"Parameters"}),e.jsx(x,{params:[{name:"storage",type:"StorageProvider",description:"Storage provider (IndexedDB in browser)",required:!0},{name:"transport",type:"TransportProvider",description:"Transport provider (Nostr in browser)",required:!0},{name:"oracle",type:"OracleProvider",description:"Aggregator oracle provider",required:!0},{name:"walletApi",type:"WalletApiTransportConfig | 'none'",description:"Wallet-api transport config from createWalletApiProviders(). Missing it throws INVALID_CONFIG; pass the literal 'none' for a messaging-only wallet with no payments, then check sphere.hasPayments before touching sphere.payments",required:!0},{name:"network",type:"'mainnet' | 'testnet2'",description:"Network this wallet runs on. Must equal walletApi.network; missing it throws INVALID_CONFIG",required:!0},{name:"mnemonic",type:"string",description:"BIP39 mnemonic to create wallet from (if no wallet exists)"},{name:"autoGenerate",type:"boolean",description:"Auto-generate mnemonic if wallet does not exist"},{name:"nametag",type:"string",description:"Register nametag on creation"},{name:"groupChat",type:"boolean | config",description:"Enable NIP-29 group chat module"},{name:"market",type:"boolean | config",description:"Enable market intent module"},{name:"password",type:"string",description:"Encrypt wallet with password"}]}),e.jsx("h4",{className:"font-medium text-lg mt-6 mb-3",children:"Returns"}),e.jsx(t,{code:`interface SphereInitResult {
  sphere: Sphere;
  created: boolean;
  generatedMnemonic?: string;
}`}),e.jsxs("p",{className:"text-neutral-600 dark:text-neutral-400 mt-4",children:[e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:"sphere"})," is the initialized instance.",e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:" created"})," says whether the wallet was newly created.",e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:" generatedMnemonic"})," is present only when",e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:" autoGenerate"})," was used."]}),e.jsx("h4",{className:"font-medium text-lg mt-6 mb-3",children:"Example"}),e.jsx("p",{className:"text-neutral-600 dark:text-neutral-400 mb-4",children:"The first call auto-creates a wallet with a generated mnemonic. The second creates one from a mnemonic you already hold."}),e.jsx(t,{filename:"init.ts",code:`import { Sphere } from '@unicitylabs/sphere-sdk';
import { createBrowserProviders } from '@unicitylabs/sphere-sdk/impl/browser';
import { createWalletApiProviders } from '@unicitylabs/sphere-sdk/impl/shared/wallet-api';
...
}`})]}),e.jsxs("div",{id:"api-sphere-mnemonic","data-section":"api-sphere-mnemonic",className:"scroll-mt-24 mb-12",children:[e.jsx("h3",{className:"text-xl font-semibold mb-4",children:e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:"Mnemonic Utilities"})}),e.jsx("p",{className:"text-neutral-600 dark:text-neutral-400 mb-4",children:"Static helpers for generating and validating BIP39 mnemonics."}),e.jsx(t,{code:`const mnemonic12 = Sphere.generateMnemonic();
const mnemonic24 = Sphere.generateMnemonic(256);

const isValid = Sphere.validateMnemonic('abandon badge cable ...');
console.log(isValid);`}),e.jsxs("p",{className:"text-neutral-600 dark:text-neutral-400 mb-4",children:[e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:"generateMnemonic()"})," returns 12 words from 128 bits of entropy. Pass ",e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:"256"})," for a 24-word mnemonic.",e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:" validateMnemonic()"})," returns",e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:" true"})," or",e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:" false"}),"."]})]})]}),e.jsxs("section",{id:"api-instance","data-section":"api-instance",className:"mb-16",children:[e.jsx("h2",{className:"text-2xl font-bold mb-6 pb-2 border-b border-neutral-200 dark:border-neutral-700",children:"API Reference — Sphere (Instance)"}),e.jsxs("div",{id:"api-instance-identity","data-section":"api-instance-identity",className:"scroll-mt-24 mb-12",children:[e.jsx("h3",{className:"text-xl font-semibold mb-4",children:e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:"sphere.identity"})}),e.jsxs("p",{className:"text-neutral-600 dark:text-neutral-400 mb-4",children:["The current wallet identity. Available after initialization. Every field except",e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:" chainPubkey"})," is optional, so guard",e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:" directAddress"})," before using it as a recipient."]}),e.jsx(t,{code:`interface Identity {
...
console.log(sphere.identity?.nametag);`}),e.jsxs("ul",{className:"list-disc list-inside text-neutral-600 dark:text-neutral-400 space-y-2 mb-4",children:[e.jsxs("li",{children:[e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:"chainPubkey"})," — the secp256k1 public key as hex"]}),e.jsxs("li",{children:[e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:"directAddress"})," — the ",e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:"DIRECT://"})," address used on L3"]}),e.jsxs("li",{children:[e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:"nametag"})," — the registered nametag without the ",e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:"@"}),", such as ",e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:"'alice'"})]})]})]}),e.jsxs("div",{id:"api-instance-nametag","data-section":"api-instance-nametag",className:"scroll-mt-24 mb-12",children:[e.jsx("h3",{className:"text-xl font-semibold mb-4",children:e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:"Nametag Methods"})}),e.jsxs("p",{className:"text-neutral-600 dark:text-neutral-400 mb-4",children:["A nametag is a Nostr identity binding (UNIP-01) linking the name to your",e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:" chainPubkey"}),", not a token.",e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:" registerNametag()"})," publishes that binding, and nothing is minted on chain."]}),e.jsx(t,{code:`sphere.getNametag();
sphere.hasNametag();

await sphere.registerNametag('alice');

const available = await sphere.isNametagAvailable('bob');`}),e.jsxs("ul",{className:"list-disc list-inside text-neutral-600 dark:text-neutral-400 space-y-2 mb-4",children:[e.jsxs("li",{children:[e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:"getNametag()"})," — the current nametag, ",e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:"'alice' | undefined"}),", with no ",e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:"@"})," prefix"]}),e.jsxs("li",{children:[e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:"hasNametag()"})," — a boolean: whether one is registered"]}),e.jsxs("li",{children:[e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:"registerNametag(name)"})," — registers a new nametag"]}),e.jsxs("li",{children:[e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:"isNametagAvailable(name)"})," — a boolean: whether the name is free"]})]})]}),e.jsxs("div",{id:"api-instance-resolve","data-section":"api-instance-resolve",className:"scroll-mt-24 mb-12",children:[e.jsx("h3",{className:"text-xl font-semibold mb-4",children:e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:"sphere.resolve(identifier)"})}),e.jsxs("p",{className:"text-neutral-600 dark:text-neutral-400 mb-4",children:["Resolves a @nametag or bare nametag, a DIRECT:// address, a compressed chain pubkey (02/03 + 64 hex) or a 64-hex transport pubkey to full peer info. Anything else is tried as a nametag and resolves to",e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:" null"}),"."]}),e.jsx(t,{code:"async resolve(identifier: string): Promise<PeerInfo | null>"}),e.jsx(t,{filename:"resolve.ts",code:`const peer = await sphere.resolve('@alice');
if (peer) {
...
off<T extends SphereEventType>(type: T, handler: (data: SphereEventMap[T]) => void): void`}),e.jsx("h4",{className:"font-medium text-lg mt-6 mb-3",children:"Event Types"}),e.jsx(x,{params:[{name:"transfer:incoming",type:"IncomingTransfer",description:"New incoming transfer. Fungible tokens are in .tokens, NFTs in .coinless"},{name:"transfer:updated",type:"TransferResult",description:"Outgoing transfer updated (confirmed, delivery pending or failed)"},{name:"message:dm",type:"DirectMessage",description:"Direct message received"},{name:"payment_request:incoming",type:"PaymentRequestView",description:"Payment request received"}]}),e.jsxs("p",{className:"text-neutral-600 dark:text-neutral-400 mt-4",children:["Handlers are typed from the event name, so these rarely need importing. To name one yourself,",e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:" PaymentRequestView"})," comes from",e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:" @unicitylabs/sphere-sdk/payments-v2"}),"; the other three are exported from the package root."]}),e.jsx(t,{filename:"events.ts",code:`const unsub = sphere.on('transfer:incoming', (transfer) => {
  console.log('Tokens received:', transfer.tokens);
});

unsub();

sphere.off('transfer:incoming', myHandler);`}),e.jsxs("p",{className:"text-neutral-600 dark:text-neutral-400 mt-4",children:[e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:"on()"})," returns an unsubscribe function — call",e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:" unsub()"})," when you are done listening.",e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:" off()"})," removes one specific handler instead."]})]}),e.jsxs("div",{id:"api-instance-wallet","data-section":"api-instance-wallet",className:"scroll-mt-24 mb-12",children:[e.jsx("h3",{className:"text-xl font-semibold mb-4",children:e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:"Wallet Management"})}),e.jsx(t,{code:`const mnemonic = sphere.getMnemonic();
...
await sphere.destroy();`}),e.jsxs("ul",{className:"list-disc list-inside text-neutral-600 dark:text-neutral-400 space-y-2 mb-4",children:[e.jsxs("li",{children:[e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:"getMnemonic()"})," — the backup mnemonic, typed",e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:" string | null"})]}),e.jsxs("li",{children:[e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:"exportToJSON()"})," — returns a",e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:" WalletJSON"})," object, not a string, so stringify it before writing a file. ",e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:"includeMnemonic"})," puts the seed in the backup, and ",e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:"password"})," encrypts it. Both are optional."]}),e.jsxs("li",{children:[e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:"exportToTxt()"})," — the text export, already a string"]}),e.jsxs("li",{children:[e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:"deriveAddress(0)"})," derives one address;",e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:" deriveAddresses(5)"})," derives the first five"]}),e.jsxs("li",{children:[e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:"switchToAddress(1)"})," changes the active address"]}),e.jsxs("li",{children:[e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:"getWalletInfo()"})," —",e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:" derivationMode"})," logs",e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:" 'bip32'"}),", and",e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:" source"})," is",e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:" 'mnemonic' | 'file' | 'unknown'"})]}),e.jsxs("li",{children:[e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:"destroy()"})," releases the wallet's resources"]})]})]})]}),e.jsxs("section",{id:"api-payments","data-section":"api-payments",className:"mb-16",children:[e.jsx("h2",{className:"text-2xl font-bold mb-6 pb-2 border-b border-neutral-200 dark:border-neutral-700",children:"API Reference — Payments (L3)"}),e.jsxs("p",{className:"text-neutral-600 dark:text-neutral-400 mb-4",children:["All L3 payment operations are accessed via ",e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:"sphere.payments"})," — available on every wallet composed with a wallet-api transport. The one exception is the messaging-only composition",e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:" walletApi: 'none'"}),", where the getter throws",e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:" PAYMENTS_NOT_COMPOSED"}),"; branch on",e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:" sphere.hasPayments"}),"."]}),e.jsxs("p",{className:"text-neutral-600 dark:text-neutral-400 mb-8",children:[e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:"coinId"})," is the 64-character lowercase hex coin id — no",e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:" 0x"})," prefix. Get it from",e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:" getCoinIdBySymbol('UCT')"})," after",e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:" await TokenRegistry.waitForReady()"}),", or take it from",e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:" assets()"}),". A prefixed id matches no holdings, and",e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:" mint()"})," resolves",e.jsxs("code",{className:"text-amber-600 dark:text-amber-400",children:[" ","{ success: false }"]})," with nothing minted."]}),e.jsxs("div",{id:"api-payments-send","data-section":"api-payments-send",className:"scroll-mt-24 mb-12",children:[e.jsx("h3",{className:"text-xl font-semibold mb-4",children:e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:"sphere.payments.send(request)"})}),e.jsx("p",{className:"text-neutral-600 dark:text-neutral-400 mb-4",children:"Sends tokens to a recipient. Supports @nametags and direct addresses."}),e.jsx("h4",{className:"font-medium text-lg mt-6 mb-3",children:"Signature"}),e.jsx(t,{code:"async send(request: SendRequest): Promise<TransferResult>"}),e.jsx("h4",{className:"font-medium text-lg mt-6 mb-3",children:"Parameters"}),e.jsx(x,{params:[{name:"coinId",type:"string",description:"64-char lowercase hex coin id (no 0x prefix)",required:!0},{name:"amount",type:"string",description:"Amount in smallest units",required:!0},{name:"recipient",type:"string",description:"@nametag or DIRECT:// address",required:!0},{name:"memo",type:"string",description:"Optional memo"}]}),e.jsx("h4",{className:"font-medium text-lg mt-6 mb-3",children:"Returns"}),e.jsx(t,{code:`interface TransferResult {
  id: string;
...
}`}),e.jsxs("p",{className:"text-neutral-600 dark:text-neutral-400 mt-4 mb-4",children:["An ",e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:"Asset"})," also carries",e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:" name"}),",",e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:" iconUrl"}),", the",e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:" confirmed*"}),"/",e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:"unconfirmed*"})," counterparts,",e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:" priceEur"}),",",e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:" change24h"})," and",e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:" fiatValueEur"}),"."]}),e.jsxs("p",{className:"text-neutral-600 dark:text-neutral-400 mb-4",children:["Called with no argument it returns every asset. Pass a",e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:" coinId"})," to get only that one."]}),e.jsx(t,{filename:"balance.ts",code:"const assets = await sphere.payments.assets();\nassets.forEach(a => console.log(`${a.symbol}: ${a.totalAmount} ($${a.fiatValueUsd})`));\n\nconst [asset] = await sphere.payments.assets(coinId);\nconsole.log('Balance:', asset?.totalAmount);"})]}),e.jsxs("div",{id:"api-payments-getassets","data-section":"api-payments-getassets",className:"scroll-mt-24 mb-12",children:[e.jsx("h3",{className:"text-xl font-semibold mb-4",children:e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:"sphere.payments.mint(coinId, amount)"})}),e.jsx("p",{className:"text-neutral-600 dark:text-neutral-400 mb-4",children:"Self-mints fungible tokens to this wallet (testnet top-up — no faucet)."}),e.jsx(t,{code:"async mint(coinId: string, amount: bigint): Promise<MintResult>"}),e.jsx(t,{filename:"mint.ts",code:`const result = await sphere.payments.mint(coinId, 100000000n);
if (result.success) {
  console.log('Minted token:', result.tokenId);
}`})]}),e.jsxs("div",{id:"api-payments-gettokens","data-section":"api-payments-gettokens",className:"scroll-mt-24 mb-12",children:[e.jsx("h3",{className:"text-xl font-semibold mb-4",children:e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:"sphere.payments.tokens(filter?)"})}),e.jsxs("p",{className:"text-neutral-600 dark:text-neutral-400 mb-4",children:["Returns individual token objects. Optionally filter by coin ID. Synchronous. Coinless (NFT) holdings are never returned here and never counted by ",e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:"assets()"})," — read them with",e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:" sphere.payments.coinless()"}),"."]}),e.jsx(t,{code:"tokens(filter?: { coinId?: string }): Token[]"}),e.jsx(t,{filename:"tokens.ts",code:`const tokens = sphere.payments.tokens();
...
}`}),e.jsxs("p",{className:"text-neutral-600 dark:text-neutral-400 mt-4",children:["Each entry's ",e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:"type"})," is",e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:" 'SENT'"}),",",e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:" 'RECEIVED'"})," or",e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:" 'MINT'"}),", and",e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:" timestamp"})," is epoch ms. While",e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:" more"})," is true, pass",e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:" cursor"})," as",e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:" before"})," to get the next, older page."]})]}),e.jsxs("div",{id:"api-payments-receive","data-section":"api-payments-receive",className:"scroll-mt-24 mb-12",children:[e.jsx("h3",{className:"text-xl font-semibold mb-4",children:e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:"sphere.payments.receive()"})}),e.jsxs("p",{className:"text-neutral-600 dark:text-neutral-400 mb-4",children:["Explicitly checks for and processes incoming token transfers. A coinless (NFT) arrival is named in",e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:" transfer.coinless"}),", never in",e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:" transfer.tokens"}),", which is empty for it — read both."]}),e.jsx(t,{code:"async receive(): Promise<{ transfers: IncomingTransfer[] }>"}),e.jsx(t,{filename:"receive.ts",code:`const { transfers } = await sphere.payments.receive();
...
sphere.payments.requests.dismissProcessed();`}),e.jsxs("ul",{className:"list-disc list-inside text-neutral-600 dark:text-neutral-400 space-y-2 mb-4",children:[e.jsxs("li",{children:[e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:"create(recipient, terms)"})," sends a payment request to a peer"]}),e.jsxs("li",{children:[e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:"payment_request:incoming"})," fires for requests sent to you"]}),e.jsxs("li",{children:[e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:"list()"})," returns every request, so filter it by ",e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:"status"})," yourself"]}),e.jsxs("li",{children:[e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:"pay(requestId)"})," settles one, ",e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:"decline(requestId)"})," rejects it"]}),e.jsxs("li",{children:[e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:"dismissProcessed()"})," clears the paid, rejected and expired requests from the list"]})]})]})]}),e.jsxs("section",{id:"api-comms","data-section":"api-comms",className:"mb-16",children:[e.jsx("h2",{className:"text-2xl font-bold mb-6 pb-2 border-b border-neutral-200 dark:border-neutral-700",children:"API Reference — Communications"}),e.jsxs("p",{className:"text-neutral-600 dark:text-neutral-400 mb-8",children:["End-to-end encrypted messaging via Nostr, accessed via ",e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:"sphere.communications"}),"."]}),e.jsxs("div",{id:"api-comms-senddm","data-section":"api-comms-senddm",className:"scroll-mt-24 mb-12",children:[e.jsx("h3",{className:"text-xl font-semibold mb-4",children:e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:"sphere.communications.sendDM(recipient, content)"})}),e.jsx("p",{className:"text-neutral-600 dark:text-neutral-400 mb-4",children:"Sends an encrypted direct message to a peer. The content is a string, so serialize structured data as JSON yourself."}),e.jsx(t,{code:"async sendDM(recipient: string, content: string): Promise<DirectMessage>"}),e.jsx(x,{params:[{name:"recipient",type:"string",description:"@nametag or transport pubkey",required:!0},{name:"content",type:"string",description:"Message content (plain text or JSON string)",required:!0}]}),e.jsx(t,{filename:"send-dm.ts",code:`const msg = await sphere.communications.sendDM('@alice', 'Hello!');
...
});`}),e.jsxs("p",{className:"text-neutral-600 dark:text-neutral-400 mt-4",children:["Call ",e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:"unsub()"})," when you stop listening."]})]}),e.jsxs("div",{id:"api-comms-conversations","data-section":"api-comms-conversations",className:"scroll-mt-24 mb-12",children:[e.jsx("h3",{className:"text-xl font-semibold mb-4",children:e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:"Conversations"})}),e.jsxs("p",{className:"text-neutral-600 dark:text-neutral-400 mb-4",children:[e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:"getConversations()"})," returns every conversation grouped by peer, as a ",e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:"Map<string, DirectMessage[]>"}),"."]}),e.jsx(t,{code:`const conversations = sphere.communications.getConversations();
...
const unread = sphere.communications.getUnreadCount();`}),e.jsxs("ul",{className:"list-disc list-inside text-neutral-600 dark:text-neutral-400 space-y-2 mb-4",children:[e.jsxs("li",{children:[e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:"getConversation(peerPubkey)"})," — the messages with one peer"]}),e.jsxs("li",{children:[e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:"deleteConversation(peerPubkey)"})," — deletes that conversation"]}),e.jsxs("li",{children:[e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:"markAsRead(ids)"})," — marks those message ids read"]}),e.jsxs("li",{children:[e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:"getUnreadCount()"})," — the unread count"]})]})]}),e.jsxs("div",{id:"api-comms-broadcast","data-section":"api-comms-broadcast",className:"scroll-mt-24 mb-12",children:[e.jsx("h3",{className:"text-xl font-semibold mb-4",children:e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:"Broadcasts"})}),e.jsx("p",{className:"text-neutral-600 dark:text-neutral-400 mb-4",children:"Send public messages to topics. Anyone subscribed to those tags will see them."}),e.jsx(t,{code:`await sphere.communications.broadcast('New item listed!', ['marketplace', 'collectibles']);
...
const recent = sphere.communications.getBroadcasts(50);`}),e.jsxs("ul",{className:"list-disc list-inside text-neutral-600 dark:text-neutral-400 space-y-2 mb-4",children:[e.jsxs("li",{children:[e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:"broadcast(content, tags)"})," publishes a message under those tags"]}),e.jsxs("li",{children:[e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:"subscribeToBroadcasts(tags)"})," subscribes to the given tags and returns an unsubscribe function"]}),e.jsxs("li",{children:[e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:"onBroadcast(handler)"})," delivers incoming broadcasts"]}),e.jsxs("li",{children:[e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:"getBroadcasts(50)"})," returns the 50 most recent broadcasts"]})]})]})]}),e.jsxs("section",{id:"api-groupchat","data-section":"api-groupchat",className:"mb-16",children:[e.jsx("h2",{className:"text-2xl font-bold mb-6 pb-2 border-b border-neutral-200 dark:border-neutral-700",children:"API Reference — Group Chat (NIP-29)"}),e.jsxs("p",{className:"text-neutral-600 dark:text-neutral-400 mb-4",children:["NIP-29 group messaging via ",e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:"sphere.groupChat"}),". Requires ",e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:"groupChat: true"})," in initialization.",e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:" sphere.groupChat"})," is",e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:" GroupChatModule | null"})," — null until you enable it, so narrow it once. Each message carries ",e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:"senderPubkey"}),", plus",e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:" senderNametag"})," when the sender published one."]}),e.jsx(t,{filename:"group-chat.ts",code:`const chat = sphere.groupChat;
...
await chat.leaveGroup('group-id');`}),e.jsxs("ul",{className:"list-disc list-inside text-neutral-600 dark:text-neutral-400 space-y-2 mb-4",children:[e.jsxs("li",{children:[e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:"connect()"})," opens the NIP-29 relay connection"]}),e.jsxs("li",{children:[e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:"fetchAvailableGroups()"})," discovers public groups"]}),e.jsxs("li",{children:[e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:"joinGroup(id)"})," joins one, ",e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:"leaveGroup(id)"})," leaves it"]}),e.jsxs("li",{children:[e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:"sendMessage(id, content)"})," posts to a group"]}),e.jsxs("li",{children:[e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:"fetchMessages(id)"})," pulls the message history"]}),e.jsxs("li",{children:[e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:"onMessage(handler)"})," delivers new messages as they arrive"]}),e.jsxs("li",{children:[e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:"getGroups()"})," returns the groups you belong to"]}),e.jsxs("li",{children:[e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:"createGroup(options)"})," creates a new one"]})]})]}),e.jsxs("section",{id:"api-market","data-section":"api-market",className:"mb-16",children:[e.jsx("h2",{className:"text-2xl font-bold mb-6 pb-2 border-b border-neutral-200 dark:border-neutral-700",children:"API Reference — Market"}),e.jsxs("p",{className:"text-neutral-600 dark:text-neutral-400 mb-4",children:["Intent bulletin board via ",e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:"sphere.market"}),". Requires ",e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:"market: true"})," in initialization. Listings do not live on chain and are not carried by Nostr: they are served by the market API at",e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:" https://market-api.unicity.network"}),", which you can point elsewhere with",e.jsxs("code",{className:"text-amber-600 dark:text-amber-400",children:[" market: ","{ apiUrl }"]}),". Search is public; posting, listing your own intents and closing them register your wallet once (",e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:"/api/agent/register"}),") and sign each request with your address key, so an intent is tied to the identity that posted it. The live feed is a WebSocket on the same host (",e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:"/ws/feed"}),").",e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:" sphere.market"})," is",e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:" MarketModule | null"})," — null until you enable it. The feed callback receives either an initial batch or a single new listing; each listing carries",e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:" title"})," and",e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:" descriptionPreview"})," (",e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:"description"})," is on search results only)."]}),e.jsx(t,{filename:"market.ts",code:`const market = sphere.market;
...
});`}),e.jsxs("p",{className:"text-neutral-600 dark:text-neutral-400 mb-4",children:[e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:"dapp.icon"})," is shown in the wallet approval dialog."]}),e.jsxs("p",{className:"text-neutral-600 dark:text-neutral-400 mb-4",children:[e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:"network"})," is required. The wallet’s compatibility gate treats a missing or mismatched network as",e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:" INCOMPATIBLE_NETWORK"})," (4008) and refuses the handshake before any UI appears. Take the id from the",e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:" SPHERE_NETWORKS"})," table so it cannot drift:",e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:" SPHERE_NETWORKS.testnet2"})," or",e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:" SPHERE_NETWORKS.mainnet"}),"."]}),e.jsxs("p",{className:"text-neutral-600 dark:text-neutral-400 mb-4",children:[e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:"walletUrl"})," matters only to the popup fallback (P3), where ",e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:"autoConnect"})," opens",e.jsxs("code",{className:"text-amber-600 dark:text-amber-400",children:[" ","<walletUrl>","/connect?origin=","<your origin>"]}),". Passing it is harmless. It is not what makes the iframe path work — that needs Sphere to frame your page."]}),e.jsx("p",{className:"text-neutral-600 dark:text-neutral-400 mb-4",children:"Ask for exactly the scopes this file uses. Every query, intent and event subscription below maps to one:"}),e.jsxs("ul",{className:"list-disc list-inside text-neutral-600 dark:text-neutral-400 space-y-2 mb-4",children:[e.jsxs("li",{children:[e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:"identity:read"})," —",e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:" sphere_getIdentity"})]}),e.jsxs("li",{children:[e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:"balance:read"})," —",e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:" sphere_getBalance"})]}),e.jsxs("li",{children:[e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:"transfer:request"})," — the",e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:" send"})," intent. Without it the intent is refused with ",e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:"PERMISSION_DENIED"})," (4002)."]}),e.jsxs("li",{children:[e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:"events:subscribe"})," —",e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:" client.on('transfer:incoming', …)"}),". The subscribe RPC fails silently, so without this scope the handler never fires."]})]}),e.jsxs("p",{className:"text-neutral-600 dark:text-neutral-400 mb-4",children:["Queries are read-only. The ",e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:"send"})," intent is not: it moves money, and the wallet asks the user to confirm it."]}),e.jsx(t,{filename:"connect-example.ts",code:`const identity = await client.query('sphere_getIdentity');
...
});`}),e.jsxs("p",{className:"text-neutral-600 dark:text-neutral-400 mb-4",children:[e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:"to"})," takes a Unicity ID or a",e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:" DIRECT://"})," address.",e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:" amount"})," is in base units — the smallest indivisible unit — as a positive integer string.",e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:" coinId"})," is required, and it is the bare lowercase hex id with no ",e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:"0x"})," prefix; read one off",e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:" sphere_getAssets"}),". Omit it and the wallet rejects the intent with ",e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:"INVALID_PARAMS"}),"."]}),e.jsxs("p",{className:"text-neutral-600 dark:text-neutral-400 mb-4",children:["The result is",e.jsxs("code",{className:"text-amber-600 dark:text-amber-400",children:[" ","{ success: true, transferId?: string, status: string, deliveryPending: boolean }"]}),".",e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:" deliveryPending: true"})," means the spend is final on-chain and the recipient’s delivery is queued; it retries automatically. Never re-send it."]}),e.jsxs("p",{className:"text-neutral-600 dark:text-neutral-400 mb-4",children:["A lock is a state, not a teardown. The session is still alive: do not disconnect, do not clear your saved session, do not re-handshake. Until the wallet is unlocked, every request except",e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:" sphere_getIdentity"}),",",e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:" sphere_subscribe"}),",",e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:" sphere_unsubscribe"})," and",e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:" sphere_disconnect"})," is answered",e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:" WALLET_LOCKED"})," (4009).",e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:" sphere_getIdentity"})," is served from the pre-lock snapshot, so keep showing the connected identity. Show a banner and keep everything else."]}),e.jsx("p",{className:"text-neutral-600 dark:text-neutral-400 mb-4",children:"The wallet shows its own passive “requests blocked — Unlock” badge. Nothing you do can raise its password field, and you should not try."}),e.jsxs("p",{className:"text-neutral-600 dark:text-neutral-400 mb-4",children:[e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:"ConnectEventHandler"})," is",e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:" (data: unknown) => void"}),", so destructuring the payload directly does not compile under strict TypeScript. Narrow it with the exported payload type."]}),e.jsx(t,{filename:"connect-example.ts",code:`client.on(WALLET_EVENTS.LOCKED, () => {
...
});`}),e.jsx("p",{className:"text-neutral-600 dark:text-neutral-400 mb-4",children:"On unlock the same session continues: no re-handshake, no re-approval, and no re-subscribe, because the host re-arms your event streams before it sends the event. The payload carries the wallet’s identity at unlock time, and it is not guaranteed to be the wallet you connected with — the lock screen’s “Forgot password → restore from recovery phrase” installs a different seed. Compare before you retry anything. A different wallet is a new connection, so disconnect and start over."}),e.jsxs("p",{className:"text-neutral-600 dark:text-neutral-400 mb-4",children:[e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:"wallet:disconnected"})," is the teardown signal. The session is gone — logout, wallet deleted, you called",e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:" disconnect"}),", the session expired, or a different seed was restored behind the lock screen. Clear your session and re-handshake to continue. Unlocking does not cure it."]}),e.jsxs("p",{className:"text-neutral-600 dark:text-neutral-400 mb-4",children:["An old wallet (Connect 2.0) never sends",e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:" wallet:unlocked"}),", so do not wait for one. There a lock ends the session: reconnect on",e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:" wallet:locked"})," instead."]}),e.jsxs("p",{className:"text-neutral-600 dark:text-neutral-400 mb-4",children:[e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:"identity:changed"})," fires when the active wallet address switches. Its payload is the new public identity, narrowed the same way. Update the identity you display."]}),e.jsx(t,{filename:"connect-example.ts",code:`client.on(WALLET_EVENTS.DISCONNECTED, () => {
  clearSession();
  showConnectButton();
});
...
if (!market) throw new Error('market is not enabled');`}),e.jsxs("p",{className:"text-neutral-600 dark:text-neutral-400 mt-4",children:[e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:"init()"})," loads the wallet already in this browser’s storage. ",e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:"autoGenerate"})," only fires when there is none, and hands the phrase to the user to write down."]}),e.jsxs("p",{className:"text-neutral-600 dark:text-neutral-400 mt-4",children:["Never put a seed phrase in a build-time variable. Anything prefixed",e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:" VITE_"})," is inlined into the bundle and served to every visitor — that is publishing the wallet, not configuring it."]}),e.jsxs("p",{className:"text-neutral-600 dark:text-neutral-400 mt-4",children:["To let a user bring an existing wallet, take the phrase from an input they fill in and pass it as",e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:" mnemonic"})," — see",e.jsx("a",{href:"#guide-wallet-backup",className:"text-orange-500 hover:underline",children:" Wallet Backup & Recovery"}),". A seed that comes from your configuration rather than from the user is a seed you have distributed."]}),e.jsx("h4",{className:"font-medium text-lg mt-6 mb-3",children:"Step 2: Post Listings"}),e.jsx(t,{code:`await market.postIntent({
  description: 'Vintage Rolex Submariner - Excellent condition',
  intentType: 'sell',
  category: 'watches',
  price: 15000,
  currency: 'UCT',
});`}),e.jsx("h4",{className:"font-medium text-lg mt-6 mb-3",children:"Step 3: Search & Negotiate"}),e.jsx(t,{code:`const results = await market.search('rolex submariner');
...
const txt = sphere.exportToTxt();`}),e.jsxs("p",{className:"text-neutral-600 dark:text-neutral-400 mt-4",children:["The mnemonic is the most important backup.",e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:" exportToJSON()"})," wraps it in the addresses and the wallet metadata; ",e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:"exportToTxt()"})," writes a plain-text backup, and takes the same ",e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:"password"})," and",e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:" addressCount"})," options."]}),e.jsx("h4",{className:"font-medium text-lg mt-6 mb-3",children:"Recovery"}),e.jsxs("p",{className:"text-neutral-600 dark:text-neutral-400 mb-4",children:[e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:"providers"})," below is the composed bundle from",e.jsx("a",{href:"#browser-setup",className:"text-orange-500 hover:underline",children:" Browser Setup"})," —",e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:" createBrowserProviders(...)"})," wrapped in",e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:" createWalletApiProviders(...)"}),". Every entry point needs the same ",e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:"network"})," as",e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:" walletApi.network"}),"."]}),e.jsxs("p",{className:"text-neutral-600 dark:text-neutral-400 mb-4",children:["The mnemonic comes from the user at runtime — a textarea they paste into, a hardware prompt, whatever your UI is. Never a build-time constant, and never",e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:" import.meta.env"}),": a",e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:" VITE_"})," variable is inlined into the bundle and served to every visitor, so a seed put there is a published seed."]}),e.jsx(t,{code:`const NETWORK = 'testnet2';
...
});`}),e.jsxs("p",{className:"text-neutral-600 dark:text-neutral-400 mt-4",children:["Since 0.17.4 an import over a storage that already holds a wallet is refused with",e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:" ALREADY_INITIALIZED"}),", and that wallet is left untouched. ",e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:"importFromJSON"})," returns that refusal as ",e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:"{ success: false, error }"}),"; the other paths reject. Pass ",e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:"overwrite: true"})," only after the user has confirmed the replacement — the old wallet is erased before the new one is brought up, and it is not restored if that fails."]}),e.jsxs("p",{className:"text-neutral-600 dark:text-neutral-400 mt-4",children:[e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:"importFromLegacyFile"})," reads the older backup files: ",e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:".txt"})," and JSON exports.",e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:" .dat"})," was removed."]})]})]}),e.jsxs("section",{id:"examples","data-section":"examples",className:"mb-16",children:[e.jsx("h2",{className:"text-2xl font-bold mb-6 pb-2 border-b border-neutral-200 dark:border-neutral-700",children:"Examples"}),e.jsxs("div",{id:"example-payment","data-section":"example-payment",className:"scroll-mt-24 mb-12",children:[e.jsx("h3",{className:"text-xl font-semibold mb-4",children:"Simple Payment"}),e.jsx("p",{className:"text-neutral-600 dark:text-neutral-400 mb-4",children:"A minimal example: initialize, check balance, send tokens, listen for incoming transfers. A brand-new wallet holds nothing, so the example stops before sending until there is a balance."}),e.jsx(t,{filename:"simple-payment.ts",code:`import { Sphere, isPossiblyCommittedSendOutcome } from '@unicitylabs/sphere-sdk';
import { createBrowserProviders } from '@unicitylabs/sphere-sdk/impl/browser';
import { createWalletApiProviders } from '@unicitylabs/sphere-sdk/impl/shared/wallet-api';
...
main();`}),e.jsxs("p",{className:"text-neutral-600 dark:text-neutral-400 mt-4",children:[e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:"init()"})," loads the wallet already in this browser’s storage. ",e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:"autoGenerate"})," only fires when there is none, and the throwaway wallet it creates hands its phrase straight to the user. A seed never comes from ",e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:"import.meta.env"}),":",e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:" VITE_"})," variables are inlined into the bundle and served to every visitor."]})]}),e.jsxs("div",{id:"example-marketplace","data-section":"example-marketplace",className:"scroll-mt-24 mb-12",children:[e.jsx("h3",{className:"text-xl font-semibold mb-4",children:"P2P Marketplace"}),e.jsxs("p",{className:"text-neutral-600 dark:text-neutral-400 mb-4",children:["A peer-to-peer marketplace with intents, negotiation via DM, and payment settlement.",e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:" postIntent()"})," takes",e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:" price"})," as a number, but",e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:" getMyIntents()"})," gives it back as an optional string — coerce it before comparing."]}),e.jsx(t,{filename:"p2p-marketplace.ts",code:`import { Sphere } from '@unicitylabs/sphere-sdk';
import { createBrowserProviders } from '@unicitylabs/sphere-sdk/impl/browser';
import { createWalletApiProviders } from '@unicitylabs/sphere-sdk/impl/shared/wallet-api';
...
main();`}),e.jsxs("p",{className:"text-neutral-600 dark:text-neutral-400 mt-4",children:[e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:"init()"})," loads the wallet already in this browser, or creates a throwaway one and hands its phrase to the user. Never take a seed from",e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:" import.meta.env"})," —",e.jsx("code",{className:"text-amber-600 dark:text-amber-400",children:" VITE_"})," variables ship in the bundle."]}),e.jsx("p",{className:"text-neutral-600 dark:text-neutral-400 mt-4",children:"The seller here accepts any offer within 10% of the listed price and rejects the rest, then confirms each incoming payment back to the buyer over DM."})]})]}),e.jsxs("footer",{className:"border-t border-neutral-200 dark:border-neutral-700 pt-8 mt-16",children:[e.jsxs("div",{className:"flex flex-wrap gap-6 text-sm text-neutral-600 dark:text-neutral-400 mb-6",children:[e.jsx("a",{href:"https://discord.com/invite/PGzNZT5uVp",target:"_blank",rel:"noopener noreferrer",className:"hover:text-orange-500 transition",children:"Discord"}),e.jsx("a",{href:"https://github.com/unicity-sphere/sphere",target:"_blank",rel:"noopener noreferrer",className:"hover:text-orange-500 transition",children:"GitHub"}),e.jsx("a",{href:j,target:"_blank",rel:"noopener noreferrer",className:"hover:text-orange-500 transition",children:"Developer Portal"})]}),e.jsx("p",{className:"text-sm text-neutral-500",children:"AgentSphere by Unicity Labs"})]})]})]})}export{S as DocsPage};
