import{w as b,s as v,i as y,p as x,n as $,l as g,R,M as T,m,j as C}from"./index-D7HH-DHr.js";import{n as P,r as h,c as w}from"./index-CXsjo8fP.js";const a=x({message:"",open:!1,triggerRect:{width:0,height:0,top:0,left:0},variant:"shade"}),_={state:a,subscribe(t){return y(a,()=>t(a))},subscribeKey(t,e){return v(a,t,e)},showTooltip({message:t,triggerRect:e,variant:o}){a.open=!0,a.message=t,a.triggerRect=e,a.variant=o},hide(){a.open=!1,a.message="",a.triggerRect={width:0,height:0,top:0,left:0}}},s=b(_),j=$`
  :host {
    width: 100%;
    display: block;
  }
