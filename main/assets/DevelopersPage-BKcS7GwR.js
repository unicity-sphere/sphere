import{c as p,r as m,j as e,m as n,L as x,M as b,K as u,X as g,D as w,G as k,a as f}from"./index-B4fUaqLA.js";import{Z as y}from"./zap-qWLQHlEM.js";const j=[["path",{d:"M15 21v-5a1 1 0 0 0-1-1h-4a1 1 0 0 0-1 1v5",key:"slp6dd"}],["path",{d:"M17.774 10.31a1.12 1.12 0 0 0-1.549 0 2.5 2.5 0 0 1-3.451 0 1.12 1.12 0 0 0-1.548 0 2.5 2.5 0 0 1-3.452 0 1.12 1.12 0 0 0-1.549 0 2.5 2.5 0 0 1-3.77-3.248l2.889-4.184A2 2 0 0 1 7 2h10a2 2 0 0 1 1.653.873l2.895 4.192a2.5 2.5 0 0 1-3.774 3.244",key:"o0xfot"}],["path",{d:"M4 10.95V19a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2v-8.05",key:"wn3emo"}]],N=p("store",j),v=[{href:"https://x.com/unicity_labs",icon:e.jsx(g,{className:"w-6 h-6"}),label:"X"},{href:"https://discord.com/invite/PGzNZT5uVp",icon:e.jsx(w,{className:"w-6 h-6"}),label:"Discord"},{href:"https://github.com/unicity-sphere/sphere",icon:e.jsx(k,{className:"w-6 h-6"}),label:"GitHub"},{href:"https://www.linkedin.com/company/unicity-labs/",icon:e.jsx(f,{className:"w-6 h-6"}),label:"LinkedIn"}];function S(){const[t,h]=m.useState("init"),[i,l]=m.useState(null),o=(a,s)=>{navigator.clipboard.writeText(a),l(s),setTimeout(()=>l(null),2e3)},r={init:{Icon:u,title:"Initialization",tagline:"Your key is your identity.",description:"Provider-based architecture. Your BIP39 mnemonic IS your identity. Auto-creates or loads existing wallets.",code:"const { sphere } = await Sphere.init({ ...providers, mnemonic: '...' });",fullExample:`import { Sphere } from '@unicitylabs/sphere-sdk';
...
console.log('Ready:', sphere.isReady);`,features:["Provider-based","BIP39 HD wallets","Auto-load or create","Multi-address"]},payments:{Icon:y,title:"Payments",tagline:"L3 instant. L1 on-chain.",description:"Send tokens to anyone via @nametag or address. Instant P2P settlement on Layer 3, ALPHA blockchain on Layer 1.",code:"await sphere.payments.send({ recipient: '@merchant', amount: '100', coinId });",fullExample:`// Send tokens (use @nametag or direct address)
